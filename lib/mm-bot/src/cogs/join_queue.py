...
class JoinQueue(commands.Cog, name="join"):
    ...
    #     player_profile = DynamoDbManager().query_player_profile_for_discord_account_id(
    ...
    # ) -> None:
    #     logging.info(
    #         f"Processing command to join team queue for user {ctx.message.author.name} with invite to {member}."
    #     )
    ...
    #     inviter_profile = DynamoDbManager().query_player_profile_for_discord_account_id(
    #         ctx.message.author.id
    #     )
    #     invitee_profile = DynamoDbManager().query_player_profile_for_discord_account_id(
    #         member.id
    #     )
    ...
    #         await ctx.send(
    #             f"The player you attempted to invite has not registered their account yet."
    #         )
    #         return

    #     await ctx.send(
    #         f"{member.mention}, {ctx.author.name} has invited you to a party! Do you accept?"
    #     )
    ...
    #             await ctx.send(
    #                 f"{ctx.author.mention} and {member.mention} are now in the party queue!"
    #             )
    #         else:
