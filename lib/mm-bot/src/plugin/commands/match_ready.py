...
class MatchReadyCommand(BaseResponse):
    def __init__(self, match_id: str, club_name: str, activity_name: str, is_team_mode: str):
        super().__init__()
        self._match_id = match_id
        self._club_name = club_name
        self._activity_name = activity_name
        self._is_team_mode = is_team_mode
        self._join_link = None
        self._players = []
    ...
    def add_join_link(self, join_link: str):
