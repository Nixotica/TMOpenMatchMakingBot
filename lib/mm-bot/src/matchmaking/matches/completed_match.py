...
from matchmaking.match_complete.calculate_elo import calculate_elo_2v2_ratings, calculate_elo_ratings
...
class CompletedMatch:
    ...
    def _complete_solo_match(
        ...
        for leaderboard_id in self.active_match.match_queue.leaderboard_ids:
            ...
            for original_player_elo_obj, updated_elo in updated_elo_obj.updated_elo_ratings.items():
            ...
            for original_player_elo_obj, elo_difference in updated_elo_obj.elo_differences.items():
                new_player_elo = PlayerElo(
                    tm_account_id=original_player_elo_obj.tm_account_id,
                    leaderboard_id=original_player_elo_obj.leaderboard_id,
                    elo=elo_difference,
    ...
    def _complete_2v2_match(
        ...
        for leaderboard_id in self.active_match.match_queue.leaderboard_ids:
            ...
            updated_elo_obj = calculate_elo_2v2_ratings(
                match_positions,  player_elos
            )
